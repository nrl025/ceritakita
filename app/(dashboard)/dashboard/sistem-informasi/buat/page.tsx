...
export default function BuatSistemInformasiPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        toast.error(data.error || 'Gagal membuat sistem informasi');
        return;
      }

      toast.success('Sistem informasi berhasil dibuat!');
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-start gap-3 md:gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm md:text-base text-gray-600">
            Buat informasi penting untuk siswa
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card className="bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200">
          <CardContent className="p-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-bold text-black mb-2 text-sm">Tips Membuat Informasi</h3>
                <ul className="text-xs text-gray-700 space-y-1">
                  <li>• Gunakan judul yang jelas dan deskriptif</li>
                  <li>• Sertakan detail penting seperti tanggal, waktu, dan tempat</li>
                  <li>• Tulis dengan bahasa yang mudah dipahami</li>
                  <li>• Pastikan informasi akurat dan up-to-date</li>
                </ul>
              </div>
            </div>
          </CardContent>
        ...
        <div className="flex gap-3">
          ...
          >
            <Send size={18} />
            <span>{loading ? 'Mempublikasi...' : 'Publikasikan'}</span>
          </button>
          <Link
            href="/dashboard/sistem-informasi"
